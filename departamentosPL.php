...
<html>
    <head>
        ...
        <title>departamentosPL.PHP</title>
    ...
    $sbl = new departamentosBL($code, $name, $identityclass, $observation, $identitysubclass, $active, $deleted);


    $sbl->buildLinks("departamentosPL.php", $pn, $sLink, $dLink, $pLink, $cLink, $fLink, $fbnLink, $action, $parS);
    $bpl = new basePL("document.departamentosPL", $sLink, $dLink, $pLink, $cLink, $fLink, $fbnLink);
    ...
    -->
    <body>
        <FORM action="<?php echo $action; ?>" method="post" name="departamentosPL" 
              class="italsis">

<?php
presentationLayer::buildFormTitle("departamentosBL", "Departamentos");

presentationLayer::buildInitColumn();

presentationLayer::buildIdInput($id, "document.departamentosPL", $fLink);

presentationLayer::buildInput("code", "code", "code", $code, "50");

presentationLayer::buildInput("name", "name", "name", $name, "50");

presentationLayer::buildInput("identityclass", "identityclass", "identityclass", $identityclass = 62, "50", "readonly", "");
