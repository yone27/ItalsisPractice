...
*/
    ...
    class departamentosBL extends baseBL {
...
$active,$deleted) {
          ...
          function fillGrid($pn=0,$parname="",$parvalue="") {
                $par = "";
$com = "SELECT * FROM ".$this->scheme.".entitysubclass WHERE identityclass = 62 order by name";
